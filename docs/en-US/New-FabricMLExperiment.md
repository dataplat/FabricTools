...
```
New-FabricMLExperiment [-WorkspaceId] <guid> [-MLExperimentName] <string>
 [[-MLExperimentDescription] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
The name of the ML Experiment to be created.
...
The unique identifier of the workspace where the ML Experiment will be created.
This parameter is mandatory.
