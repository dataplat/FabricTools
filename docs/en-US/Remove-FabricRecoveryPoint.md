...
title: Remove-FabricRecoveryPoint
---
...
```
Remove-FabricRecoveryPoint [[-CreateTime] <string>] [[-WorkspaceGUID] <guid>]
 [[-DataWarehouseGUID] <guid>] [[-BaseUrl] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
