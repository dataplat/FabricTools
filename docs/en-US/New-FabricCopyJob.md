...
```
New-FabricCopyJob [-WorkspaceId] <guid> [-CopyJobName] <string> [[-CopyJobDescription] <string>]
 [[-CopyJobPathDefinition] <string>] [[-CopyJobPathPlatformDefinition] <string>] [-WhatIf]
...
The name of the copy job to be created.
Mandatory.
...
The unique identifier of the workspace where the copy job will be created.
Mandatory.
