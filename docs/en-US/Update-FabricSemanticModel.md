...
title: Update-FabricSemanticModel
---
...
```
Update-FabricSemanticModel [-WorkspaceId] <guid> [-SemanticModelId] <guid>
 [-SemanticModelName] <string> [[-SemanticModelDescription] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
