...
```
Update-FabricDomain [-DomainId] <guid> [-DomainName] <string> [[-DomainDescription] <string>]
 [[-DomainContributorsScope] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
(Optional) The contributors' scope for the domain.
Accepted values: 'AdminsOnly', 'AllTenant', 'SpecificUsersAndGroups'.
