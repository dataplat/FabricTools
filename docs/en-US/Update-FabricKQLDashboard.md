...
title: Update-FabricKQLDashboard
---
...
```
Update-FabricKQLDashboard [-WorkspaceId] <guid> [-KQLDashboardId] <guid>
 [-KQLDashboardName] <string> [[-KQLDashboardDescription] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
