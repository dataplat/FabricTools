...
```
New-FabricEventhouse [-WorkspaceId] <guid> [-EventhouseName] <string>
 [[-EventhouseDescription] <string>] [[-EventhousePathDefinition] <string>]
 [[-EventhousePathPlatformDefinition] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
