...
```
Update-FabricEventhouse [-WorkspaceId] <guid> [-EventhouseId] <guid> [-EventhouseName] <string>
 [[-EventhouseDescription] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
It supports optional parameters for Eventhouse description.
