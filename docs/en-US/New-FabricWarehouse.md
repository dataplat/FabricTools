...
```
New-FabricWarehouse [-WorkspaceId] <guid> [-WarehouseName] <string>
 [[-WarehouseDescription] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
The name of the warehouse to be created.
...
The unique identifier of the workspace where the warehouse will be created.
This parameter is mandatory.
