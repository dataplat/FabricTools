...
title: Update-FabricReflexDefinition
---
...
```
Update-FabricReflexDefinition [-WorkspaceId] <guid> [-ReflexId] <guid>
 [-ReflexPathDefinition] <string> [[-ReflexPathPlatformDefinition] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
