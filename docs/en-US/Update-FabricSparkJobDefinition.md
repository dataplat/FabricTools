...
title: Update-FabricSparkJobDefinition
---
...
```
Update-FabricSparkJobDefinition [-WorkspaceId] <guid> [-SparkJobDefinitionId] <guid>
 [-SparkJobDefinitionName] <string> [[-SparkJobDefinitionDescription] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
It supports optional parameters for SparkJobDefinition description.
...
The new name of the SparkJobDefinition.
This parameter is mandatory.
