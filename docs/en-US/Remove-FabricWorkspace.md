...
```
Remove-FabricWorkspace [-WorkspaceId] <guid> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
It validates the workspace ID and handles both success and error responses.
