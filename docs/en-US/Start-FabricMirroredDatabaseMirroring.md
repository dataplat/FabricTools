...
title: Start-FabricMirroredDatabaseMirroring
---
...
```
Start-FabricMirroredDatabaseMirroring [-WorkspaceId] <guid> [[-MirroredDatabaseId] <guid>] [-WhatIf]
...
The unique identifier of the mirrored database to be started.
