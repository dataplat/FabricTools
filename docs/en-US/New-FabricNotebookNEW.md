...
```
New-FabricNotebookNEW [-WorkspaceId] <guid> [-NotebookName] <string>
 [[-NotebookDescription] <string>] [[-NotebookPathDefinition] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
It supports optional parameters for notebook description
