...
```
Update-FabricMLModel [-WorkspaceId] <guid> [-MLModelId] <guid> [[-MLModelDescription] <string>]
...
The unique identifier of the ML Model to be updated.
