...
title: Update-FabricPaginatedReport
---
...
```
Update-FabricPaginatedReport [-WorkspaceId] <guid> [-PaginatedReportId] <guid>
 [-PaginatedReportName] <string> [[-PaginatedReportDescription] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
