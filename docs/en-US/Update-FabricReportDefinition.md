...
title: Update-FabricReportDefinition
---
...
```
Update-FabricReportDefinition [-WorkspaceId] <guid> [-ReportId] <guid>
...
It supports optional parameters for Report definition and platform-specific definition.
