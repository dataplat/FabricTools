...
title: Update-FabricDataPipeline
---
...
```
Update-FabricDataPipeline [-WorkspaceId] <guid> [-DataPipelineId] <guid>
 [-DataPipelineName] <string> [[-DataPipelineDescription] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
