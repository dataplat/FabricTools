...
```
New-FabricEventstream [-WorkspaceId] <guid> [-EventstreamName] <string>
 [[-EventstreamDescription] <string>] [[-EventstreamPathDefinition] <string>]
 [[-EventstreamPathPlatformDefinition] <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
