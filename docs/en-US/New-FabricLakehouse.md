...
```
New-FabricLakehouse [-WorkspaceId] <guid> [-LakehouseName] <string>
 [[-LakehouseDescription] <string>] [[-LakehouseEnableSchemas] <bool>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
