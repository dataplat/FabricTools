...
```
Remove-FabricEventhouse [-WorkspaceId] <Guid> [-EventhouseId] <Guid> [-ProgressAction <ActionPreference>]
...
Author: Tiago Balabuch](https://learn.microsoft.com/en-us/rest/api/fabric/eventhouse/items/delete-eventhouse?tabs=HTTP
