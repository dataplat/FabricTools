...
```
New-FabricNotebookNEW [-WorkspaceId] <Guid> [-NotebookName] <String> [[-NotebookDescription] <String>]
 [[-NotebookPathDefinition] <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
