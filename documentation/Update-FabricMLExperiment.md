...
```
Update-FabricMLExperiment [-WorkspaceId] <Guid> [-MLExperimentId] <Guid> [-MLExperimentName] <String>
 [[-MLExperimentDescription] <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
