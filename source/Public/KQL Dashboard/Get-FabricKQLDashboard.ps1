...
begin {
    ...
    $KQLDashboardAPI = "$($FabricSession.BaseApiUrl)/workspaces/$WorkspaceId/KQLDashboards"

    $KQLDashboardAPIKQLDashboardId = "$($FabricSession.BaseApiUrl)/workspaces/$WorkspaceId/KQLDashboards/$KQLDashboardId"
