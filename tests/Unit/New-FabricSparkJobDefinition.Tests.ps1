...
BeforeDiscovery {
    ...
    $CommandName = 'New-FabricSparkJobDefinition'
}
...
Describe "New-FabricSparkJobDefinition" -Tag "UnitTests" {
    ...
    Context "Create Spark Job Definition successfully" {
        BeforeAll {
        ...
        It "Should create a spark job definition" {
            $result = New-FabricSparkJobDefinition -WorkspaceId "00000000-0000-0000-0000-000000000000" -SparkJobDefinitionName "TestSparkJobDefinition" -Confirm:$false
            ...
            Should -Invoke -CommandName Invoke-FabricRestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -like "*workspaces/00000000-0000-0000-0000-000000000000/sparkJobDefinitions*" -and
                $Method -eq "Post"
            }
        }
    }
    ...
    Context "Error handling" {
        ...
        It "Should handle error gracefully and write error message" {
            { New-FabricSparkJobDefinition -WorkspaceId "00000000-0000-0000-0000-000000000000" -SparkJobDefinitionName "TestSparkJobDefinition" -Confirm:$false } | Should -Not -Throw

            Should -Invoke -CommandName Write-Message -ParameterFilter {
                $Level -eq 'Error' -and $Message -like "*Failed to create Spark Job Definition*"
            }
        }
    }
}
