...
BeforeDiscovery {
    ...
    $CommandName = 'Remove-FabricMirroredDatabase'
}
...
Describe "Remove-FabricMirroredDatabase" -Tag "UnitTests" {
    ...
    Context "Remove Mirrored Database successfully" {
        BeforeAll {
        ...
        It "Should remove a mirrored database" {
            { Remove-FabricMirroredDatabase -WorkspaceId "00000000-0000-0000-0000-000000000000" -MirroredDatabaseId "00000000-0000-0000-0000-000000000001" -Confirm:$false } | Should -Not -Throw

            Should -Invoke -CommandName Invoke-FabricRestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -like "*workspaces/*/mirroredDatabases/*" -and
                $Method -eq "Delete"
            }
        }
    }
