...
BeforeDiscovery {
    ...
    $CommandName = 'Remove-FabricSemanticModel'
}
...
Describe "Remove-FabricSemanticModel" -Tag "UnitTests" {
    ...
    Context "Remove Semantic Model successfully" {
        BeforeAll {
        ...
        It "Should remove a semantic model" {
            { Remove-FabricSemanticModel -WorkspaceId "00000000-0000-0000-0000-000000000000" -SemanticModelId "00000000-0000-0000-0000-000000000001" -Confirm:$false } | Should -Not -Throw
