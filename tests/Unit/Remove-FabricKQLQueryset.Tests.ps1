...
BeforeDiscovery {
    ...
    $CommandName = 'Remove-FabricKQLQueryset'
}
...
Describe "Remove-FabricKQLQueryset" -Tag "UnitTests" {
    ...
    Context "Remove KQL Queryset successfully" {
        BeforeAll {
        ...
        It "Should remove a KQL queryset" {
            { Remove-FabricKQLQueryset -WorkspaceId "00000000-0000-0000-0000-000000000000" -KQLQuerysetId "00000000-0000-0000-0000-000000000001" -Confirm:$false } | Should -Not -Throw

            Should -Invoke -CommandName Invoke-FabricRestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -like "*workspaces/*/kqlQuerysets/*" -and
                $Method -eq "Delete"
            }
        }
    }
