...
BeforeDiscovery {
    ...
    $CommandName = 'Remove-FabricSparkJobDefinition'
}
...
Describe "Remove-FabricSparkJobDefinition" -Tag "UnitTests" {
    ...
    Context "Remove Spark Job Definition successfully" {
        BeforeAll {
        ...
        It "Should remove a spark job definition" {
            { Remove-FabricSparkJobDefinition -WorkspaceId "00000000-0000-0000-0000-000000000000" -SparkJobDefinitionId "00000000-0000-0000-0000-000000000001" -Confirm:$false } | Should -Not -Throw

            Should -Invoke -CommandName Invoke-FabricRestMethod -Times 1 -Exactly -ParameterFilter {
                $Uri -like "*workspaces/*/sparkJobDefinitions/*" -and
                $Method -eq "Delete"
            }
        }
    }
