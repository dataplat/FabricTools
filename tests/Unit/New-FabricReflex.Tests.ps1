...
Describe "New-FabricReflex" -Tag "UnitTests" {
    ...
    Context "Create Reflex successfully" {
        BeforeAll {
    ...
    Context "Error handling" {
        ...
        It "Should log error when API returns error" {
            { New-FabricReflex -WorkspaceId "00000000-0000-0000-0000-000000000000" -ReflexName "TestReflex" -Confirm:$false } | Should -Not -Throw
